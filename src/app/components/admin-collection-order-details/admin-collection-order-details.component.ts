...
@Component({
  selector: 'app-admin-collection-order-details',
  templateUrl: './admin-collection-order-details.component.html',
  styleUrl: './admin-collection-order-details.component.css'
})
export class AdminCollectionOrderDetailsComponent {
